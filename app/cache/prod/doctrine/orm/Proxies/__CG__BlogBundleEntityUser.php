...
class User extends \BlogBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BlogBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'BlogBundle\\Entity\\User' . "\0" . 'role', '' . "\0" . 'BlogBundle\\Entity\\User' . "\0" . 'name', '' . "\0" . 'BlogBundle\\Entity\\User' . "\0" . 'surname', '' . "\0" . 'BlogBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'BlogBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'BlogBundle\\Entity\\User' . "\0" . 'image');
        }
