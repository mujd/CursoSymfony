 ...
 */
class EntryTag extends \BlogBundle\Entity\EntryTag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'BlogBundle\\Entity\\EntryTag' . "\0" . 'id', '' . "\0" . 'BlogBundle\\Entity\\EntryTag' . "\0" . 'entry', '' . "\0" . 'BlogBundle\\Entity\\EntryTag' . "\0" . 'tag');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EntryTag $proxy) {
