...
class Curso extends \AppBundle\Entity\Curso implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Curso' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Curso' . "\0" . 'titulo', '' . "\0" . 'AppBundle\\Entity\\Curso' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\Curso' . "\0" . 'precio');
        }
